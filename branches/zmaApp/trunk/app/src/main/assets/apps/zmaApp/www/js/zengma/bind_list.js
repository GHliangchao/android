...
// i18n 国际化资源 @since liujun 2018-11-20
var pullDownInfoText, pullDownNomoreText, tanOkText, tanCancelText,
	promptDeleteText, operateSuccessText;
i18n.readyI18n(function() {
	$("#titleText").html($.i18n.prop("bind_list_js_titleText"));
	$("#search").html($.i18n.prop("public_input_search_js_searchText"));
	$("#addbout").html($.i18n.prop("bind_list_js_addBout"));
	$("#boutCode").attr("placeholder", $.i18n.prop("bind_list_js_boutCode"));
	...
	// 你确定要删除吗？
	promptDeleteText = $.i18n.prop("bind_list_js_prompt_delete");
	// 操作成功
...
// 增加阻止冒泡事件 @since liujun 2018-11-29
function stop() {
...
function addbout() {
	...
	if (null == page) {
		mui.preload({url: "bind_addbout.html", extras:{
			appid: appid
		}});
	} else {
