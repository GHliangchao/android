...
public final class ByteUtil {
	...
	public final static String FORMAT_HEX = "hex";
	...
	public final static String dump(final byte[] buffer, final String format){
		return dump(buffer, 0, buffer.length, format);
	}
	
	public final static String dump(final byte[] buffer, int offset, int length, final String format){
		if(FORMAT_HEX.equalsIgnoreCase(format)){
			return dumphex((StringBuilder)null, buffer, offset, length);
		}
	...
	public final static byte[] parse(final String data, final String format){
		if(FORMAT_HEX.equalsIgnoreCase(format)){
