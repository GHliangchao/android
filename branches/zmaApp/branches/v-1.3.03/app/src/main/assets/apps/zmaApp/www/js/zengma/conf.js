/*统一一下重新打开某个页面使用自定义事件ppreload，如果是在该页面重新加载的，使用自定义事件getnewlist
	...
	if(dpage==null){
		mui.preload({url: "_www/forum_category.html"});
	}else{
...
// @since liujun 2018-11-30 statusbar
function setDarkStatusbar(){
//	console.log("设置状态栏dark");
//	// - statusbar
//	var nav = plus.navigator;
//	nav.setStatusBarStyle("dark");
//	nav.setStatusBarBackground("#FFF");
}
var realpath="";
function uiInit(){
	var nav, conf = this,
