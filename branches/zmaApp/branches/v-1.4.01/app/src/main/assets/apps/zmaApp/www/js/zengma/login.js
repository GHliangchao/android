...
//------------------end--------------------
// backIndex = true:点击返回键，跳到index页面
var backIndex;
function plusReady() {
	...
	backIndex = self.backIndex;
	console.log("[webinit ppreload]: redirect is "+ redirect + ", isfresh is "+ isfresh + ", backIndex is "+ backIndex);
...
mui.init({
	...
	beforeback:function(){
		...
		console.log("back index html:" + backIndex);
		if (backIndex) {
			console.log("enter index html");
			var page = plus.webview.getWebviewById("index.html");
			if (page == null) {
				console.log("open window index.html");
				mui.preload({url: "index.html"});
			}else {
				console.log("mui fire index.html");
