...
//										ers = result;
	 ...
	 * @return
	 */
    public String getUICallbackTypeMsg(FTCallback.UICallbackType uiCallbackType, String promptMsg, String lang){
	...
	public void applyPermission(IWebview web){
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			...
			int checkCoarseLocationRes = ContextCompat.checkSelfPermission(web.getContext(), Manifest.permission.ACCESS_COARSE_LOCATION);
//			if (checkCoarseLocationRes != PackageManager.PERMISSION_GRANTED) {
				ActivityCompat.requestPermissions(web.getActivity(), new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSION_REQUEST_COARSE_LOCATION);
//			}
		}
	}
