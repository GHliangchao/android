...
function setTapListener(){
	...
	// 北斗多模 since 2019.08.13 liujun
	$("#beidou")[0].addEventListener("tap", clickBeidou, false);
	// 多屏互动 since 2019.08.13 liujun
	$("#multiScreen")[0].addEventListener("tap", clickMultiScreen, false);
}

function clickMultiScreen() {
	var url = "/mulscr_ctl.html";
	openWebview(url);
}
