var vm = new Vue({
	...
	methods: {
		selectExpress: function(){
			...
			var gid = vm.codeId;
			if(page == null){
				mui.preload({url: url, extras:{gid: gid, name:vm.name, codeSn: vm.codeSn}});
			} else {
				mui.fire(page, "preloading", {gid: gid, name:vm.name, codeSn: vm.codeSn});
			}
		},
		goodsBuy: function(){
			...
			if(page == null){
				mui.preload({url: url, extras:{codeSn: vm.codeSn}});
			} else {
				mui.fire(page, "preloading", {codeSn: vm.codeSn});
			}
		}
	}
});
