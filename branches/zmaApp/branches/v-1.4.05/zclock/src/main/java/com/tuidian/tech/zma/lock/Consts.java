...
public final class Consts {
	...
	public final static String NFC_FMT_TXT = "txt", NFC_FMT_HEX = "hex";
	...
	public final static boolean DEBUG = Boolean.parseBoolean(System.getProperty(PROP_DEBUG, "true"));
	...
	/** 上次操作未完成。 */
	public final static int ER_PENDING = -2;
	
	/** 不支持NFC。*/
	public final static int ER_NONFC   = 0xFA;
	/** 连接已断开。*/
