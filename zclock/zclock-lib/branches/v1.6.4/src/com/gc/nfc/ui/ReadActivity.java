...
//				setError("NFC tag data corruption");
			...
			if (mData.startsWith("http://") || mData.startsWith("https://")) {
			    // param :<a href="mData">mData</a>
//			    final StringBuilder html = new StringBuilder("<a href=\"")
//			            .append(mData)
//			            .append("\">")
//			            .append(mData)
//			            .append("</a>");
//			    final Spanned fromHtml = Html.fromHtml(html.toString());
//			    setText(fromHtml);
				Intent intent = new Intent();  
				intent.setAction("android.intent.action.VIEW");    
		        Uri content_url = Uri.parse(mData);   
