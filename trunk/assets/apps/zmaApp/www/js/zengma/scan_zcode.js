...
//------------------start--------------------
var unknownJs, noDeviceJs, connectKeyJs, loadingJs,
...
function plusReady(){
    ...
    function onmarked(type, result) {
	    ...
	    result = result.substring((urlLength));
	    		...
	    		success: function(info){
	    			...
	    			if (info.ret == 2) {
	    				...
	    				if (dpage == null) {
	    					...
	    					mui.fire(dpage, "zmchainload", {appid:info.appid, rid:info.zcodeid, openid:ws.id});
	    				}
	    				setTimeout(function(){
	    					scan.close();
	    					scan == null;
